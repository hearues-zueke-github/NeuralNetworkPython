...
from DigitRecognition import load_pkl_file
...
def get_train_set_picture():
    inputs_targets_train = load_pkl_file("inputs_targets_train_14x14.pkl.gz")
...
def get_valid_set_picture():
    inputs_targets_valid = load_pkl_file("inputs_targets_valid_14x14.pkl.gz")
